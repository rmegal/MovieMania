...
angular.module('movieManiaApp')
  .controller('MainCtrl', function ($scope) {
    var movieList = [{
        title: 'Ace Drummond',
        image: 'https://images-na.ssl-images-amazon.com/images/M/MV5BMTMyMDA2ODE5M15BMl5BanBnXkFtZTcwNjg0NjIyMQ@@._V1_UY268_CR4,0,182,268_AL_.jpg',
      ...
      },
      {
        ...
        image: 'https://images-na.ssl-images-amazon.com/images/M/MV5BMjEyNzg3MzcyNF5BMl5BanBnXkFtZTcwNjQ2NTQyMQ@@._V1_UY268_CR2,0,182,268_AL_.jpg',
        description: 'Ten people are invited to an isolated island, only to find that an unseen person is killing them one by one. Could one of them be the killer?'
      },
      {
        title: 'Captain Kidd',
  ...
  .controller('SubCtrl', function($scope){
    $scope.title = 'Lots of awesome movies';
  })
